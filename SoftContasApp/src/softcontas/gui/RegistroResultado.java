 ...
 */
public class RegistroResultado extends javax.swing.JFrame {

    /**
     * Creates new form RegistroResultado
     */
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try{
            ...
            cria.setResultado(this);
            Contas conta = cria.criaConta(4);
    ...
    private void btnValidarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValidarActionPerformed
        ...
        if(status == false){
            ...
            dao.listar();
            dao.listarResultado();
            dao.comparaContasResultado(conta);
            dao.desconectar();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroResultado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroResultado().setVisible(true);
            }
        });
    }
